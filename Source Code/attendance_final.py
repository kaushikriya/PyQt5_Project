...
k=0
m=0
open_file=open('attendance.txt','r+')
attendedFile=open('attendedFile.txt','r+')
...
class widget(QMainWindow):
    ...
    def initUI(self):
        ...
        c=0
        open_checkbox = open('subjects.txt', 'r')
    ...
    def save(self):
        ...
        attended_file=open('attendedFile.txt','w')
        for n in range(6):
