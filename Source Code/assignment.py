...
class widget(QMainWindow):
    ...
    def initUI(self):
        sub1_open=open('sub1.txt','r')
        sub2_open = open('sub2.txt', 'r')
        sub3_open = open('sub3.txt', 'r')
        sub4_open = open('sub4.txt', 'r')
        sub5_open = open('sub5.txt', 'r')
        sub6_open = open('sub6.txt', 'r')
